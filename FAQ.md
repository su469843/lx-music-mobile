...
LX Music移动版现已支持歌曲下载功能。您可以通过以下方式下载歌曲：

1. 在歌曲列表中，长按歌曲打开菜单，选择"下载"选项
2. 在播放界面，点击菜单按钮，选择"下载"选项

下载的歌曲将保存在您设备的下载目录中，您可以在设置-下载设置中查看和修改下载路径。

注意：下载功能需要存储权限，请确保您已授予LX Music相应权限。
